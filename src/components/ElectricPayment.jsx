...
export default function ElectricPayment() {
    ...
    <div className="min-h-screen">
      <div className="md:hidden tertiary-color h-9 ">
        <button
          ...
          className="md:hidden  mr-4 flex justify-self-end"
        >
      ...
      <div className="hidden md:flex justify-between mt-8  items-center mb-6">
        <h2 className="text-xl font-bold xl:ml-44 sm:ml-64">
          Pay electric bill
        </h2>
            ...
            <div className="mt-6">
              ...
              {paymentMethod && (
                <div className="mt-6 flex justify-center items-center gap-2 primary-text text-sm">
                  ...
                  <span>
                    You have selected: <strong>{paymentMethod}</strong>
                  </span>
                </div>
              )}
            </div>
